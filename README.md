# PhotoOpsAIConnectorS3

S3 connector to PhotoOpsAI platform
...
```bash
sam logs -n <FUNCTION_NAME> --stack-name PhotoOpsAIConnectorS3 --tail
```
...
```bash
aws cloudformation delete-stack --stack-name PhotoOpsAIConnectorS3
```
